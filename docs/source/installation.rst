...
The sources for interact-cli can be downloaded from the `Github repo`_.
...
.. _Github repo: https://github.com/caizhengxin/interact-cli
.. _tarball: https://github.com/caizhengxin/interact-cli/tarball/master
